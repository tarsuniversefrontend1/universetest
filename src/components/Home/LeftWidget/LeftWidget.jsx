"use client";
import favorites from "../../../../assets/icons/home/leftWidget/favorites.svg";
import projects from "../../../../assets/icons/home/leftWidget/projects.svg";
import drafts from "../../../../assets/icons/home/leftWidget/drafts.svg";
import products from "../../../../assets/icons/home/leftWidget/products.svg";
import cart from "../../../../assets/icons/home/leftWidget/carts.svg";
      ...
      <div className="bg-white py-5  rounded-xl shadow shadow-gray-300 w-full  ">
        <div className="flex flex-col items-start">
          <div className="flex items-center gap-4 w-full group py-3.5 px-[1.7rem] hover:bg-gray-100 transition-all duration-300 cursor-pointer">
            ...
            <p className="text-miniTitle col-span-6 font-light">Favorites</p>
          </div>
