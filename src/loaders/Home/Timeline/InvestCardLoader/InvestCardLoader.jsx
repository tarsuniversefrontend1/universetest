...
const InvestCardLoader = () => {
  return (
    <div className="w-full mt-3 p-5 bg-white rounded-xl shadow-sm shadow-gray-300">
      ...
      <div className="mt-3 h-6 w-28 animate-pulse bg-gray-800 rounded-full"></div>
      ...
      <div className="flex mt-3 items-center justify-between w-full">
        ...
        <div className="w-24 rounded-full bg-black animate-pulse h-8"></div>
      </div>
    </div>
  );
}

export default InvestCardLoader